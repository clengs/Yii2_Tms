...
class AuditingModel extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id', 'title', 'proposer', 'proposer_phone', 'proposer_email', 'proposer_contry', 'require_belongto', 'terminals', 'time', 'description', 'comments', 'aprover', 'approver_idea', 'next_approver', 'have_finish'], 'required'],
