...
/**
 * DepartmentController implements the CRUD actions for DepartmentModel model.
 */
class DepartmentController extends Controller
{
    ...
    /**
     * Displays a single DepartmentModel model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Deletes an existing DepartmentModel model.
